...
\item \textbf{Hridoy Sankar Dutta}, Tanmoy Chakraborty. Blackmarket-driven Collusion among Retweeters – Analysis, Detection and Characterization,  \textit{IEEE Trans. Information Forensics and Security.} \textbf{(Major Revision)}
...
\emph{Mentored by Prof. Pete Burnap, Professor of Data Science \\ \& Cybersecurity School of Computer Science and Informatics} \hfill Mar, 2019 \\
\\
...
%\setlist[itemize]{
\begin{itemize}[leftmargin=*]
 \item \textbf{\href{https://github.com/hridaydutta123/awesome-twitter-tools}{Awesome Twitter Tools}} - A curated list of awesome Twitter tools, libraries and resources.
