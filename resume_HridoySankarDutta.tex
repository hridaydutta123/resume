...
\begin{center}
    ...
    \hspace{-\hoffset}    \large{FHEA, MACS}
    \hfill 
...
\begin{center}
    \hspace{-\hoffset}
	\href{mailto:hridoy.dutta@deakin.edu.au}{hridoy.dutta@deakin.edu.au} / \href{mailto:hridoysankardutta@gmail.com}{hridoysankardutta@gmail.com} 
\end{center}
\vspace{-7mm}
\begin{resume}
...
\begin{itemize}
 ...
 \item Supervisor: \href{https://sites.google.com/site/tanmoychakra88/}{\textbf{Dr. Tanmoy Chakraborty}}, Associate Professor \& Ramanujan Fellow, Dept. of CSE, Indraprastha Institute of Information Technology Delhi (IIIT-D), India
\end{itemize}
...
\item \textbf{[AIReview-26]} Kamel Kamel, Keshav Sood, \textbf{\underline{Hridoy Sankar Dutta}} and Sunil Aryal.  A Survey of Threats Against Voice Authentication and Anti-Spoofing Systems.  \textit{\textcolor{blue}{Springer Artificial Intelligence Review, 2026}}.

\item \textbf{[InterSpeech-26]} Kamel Kamel, \textbf{\underline{Hridoy Sankar Dutta}},  Keshav Sood and Sunil Aryal. Spectral Masking and Interpolation Attack (SMIA): A Black-box Adversarial Attack against Voice Authentication and Anti-Spoofing Systems. \textit{\textcolor{blue}{27th Conference of the International Speech Communication Association (InterSpeech 2026).}}, September 27 – October 1, 2026. 
...
\item  \textbf{[SIGIRW-25]} \textbf{\underline{Hridoy Sankar Dutta}}, Sana Ansari,  Swati Kumari and Shounak Ravi Bhalerao. OpenCoderRank: Personalized Technical Assessments with Generative AI.  \textit{The First Workshop on Synthetic Content in Information Retrieval Ecosystems,  49th International ACM SIGIR Conference on Research and Development in Information Retrieval (SIGIR 2026)}, July 20 – 24, 2026.  


\item \textbf{[IEEE-IoT]}   Kamel Kamel, Keshav Sood, \textbf{\underline{Hridoy Sankar Dutta}} and Sunil Aryal. Rethinking Targeted Data Poisoning in Voice Authentication: A Critique and Defense Mechanism, \textit{\textcolor{blue}{IEEE Internet of Things Journal}}.
...
\item  \textbf{[CIKMW-25]} Swati Kumari, \textbf{\underline{Hridoy Sankar Dutta}} and Hitesh Tiwari. Securing User Identity in Web3 Social Platforms: A Post-Quantum Biometric Approach.  \textit{6th Workshop on Secure IoT, Edge and Cloud systems,The 34th ACM Conference on Information and Knowledge Management (CIKM 2025)}, Nov 10 – 14, 2025.
...
\item \textbf{\underline{Hridoy Sankar Dutta}} and Yanna Papadodimitraki. Backlinks for Sale: A First Look into Marketplaces Selling Wikipedia Backlinks \textit{12th Annual Wiki Workshop (WikiWorkshop 2025)}, May 21 – 22, 2025.
...
\item  \textbf{[LOD-25]} Anahit Sargsyan, \textbf{\underline{Hridoy Sankar Dutta}} and Juergen Pfeffer.  Half-life of Youtube News Videos: Diffusion Dynamics and Predictive Factors.   \textit{\textcolor{blue}{The 11th International Conference on Machine Learning, Optimization, and Data Science (LOD 2025)}}, September 21 – 24, 2025, Tuscany, Italy.
...
\item Quincy Taylor,  Derek Hansen,  \textbf{\underline{Hridoy Sankar Dutta}} and Justin Giboney. Analyzing online media platforms for hacktivist group organization and proliferation,  \textit{The 15th Dewald Roode Workshop on Information Systems Security Research (DRW 2023)} 22-23 June 2023, Glasgow, Scotland.

\item Luis Adán Saavedra del Toro,  Alastair Beresford,  \textbf{\underline{Hridoy Sankar Dutta}} and Alice Hutchings. Analysis of Modded Android Apps and Marketplaces,  \textit{Fourth UK Mobile, Wearable and Ubiquitous Systems Research Symposium (MobiUK)} 4th-5th July 2022, UCL.

\item  \textbf{[ACM TDS]} \textbf{\underline{Hridoy Sankar Dutta}} and Tanmoy Chakraborty, Blackmarket-driven collusion on online media: a survey.  \textit{\textcolor{blue}{ACM/IMS Transactions on Data Science (TDS)}} 2, no. 4 (2022): 1-37.
...
\item  \textbf{[ACM TIST]}  \textbf{\underline{Hridoy Sankar Dutta}}, Mayank Jobanputra, Himani Negi, Tanmoy Chakraborty. Detecting and Analyzing Collusive Entities on YouTube,   \textit{\textcolor{blue}{ACM Transactions on Intelligent Systems and Technology (TIST)}} 12, no. 5 (2021): 1-28.

\item  \textbf{[HyperText-21]} \textbf{\underline{Hridoy Sankar Dutta}}, Kartik Aggarwal and Tanmoy Chakraborty. DECIFE: Detecting Collusive Users Involved in Blackmarket Following Services on Twitter, \textit{\textcolor{blue}{32nd ACM Conference on Hypertext and Social Media (HyperText)}}, Trinity College Dublin, Ireland,  pp. 91-100. 2021.

\item  \textbf{[ICWSM-21]} \textbf{\underline{Hridoy Sankar Dutta}}, Udit Arora and Tanmoy Chakraborty. ABOME: A Multi-platform Data Repository of Artificially Boosted Online Media Entities, \textit{\textcolor{blue}{15th International AAAI Conference on Web and Social Media (ICWSM)}}, vol. 15, pp. 1000-1008. 2021.

\item \textbf{\underline{Hridoy Sankar Dutta}} and Tanmoy Chakraborty. Adversarial Collusion on the Web: State-of-the-Art and Future Directions. In Big Data Analytics: 8th International Conference, BDA 2020, Sonepat, India, December 15–18, 2020, Proceedings 8, pp. 230-235. Springer International Publishing, 2020.

\item  \textbf{[ACM TIST]} Udit Arora*,  \textbf{\underline{Hridoy Sankar Dutta}}*,  Brihi Joshi,  Aditya Chetan and Tanmoy Chakraborty.  Analyzing and detecting collusive users involved in blackmarket retweeting activities. \textit{\textcolor{blue}{ACM Transactions on Intelligent Systems and Technology (TIST)}} 11, no. 3 (2020): 1-24.
...
\item  \textbf{[JNCA]} Partha Sarathi Paul, Bishakh Chandra Ghosh, \textbf{\underline{Hridoy Sankar Dutta}}, Kingshuk De, Arka Prava Basu, Prithviraj Pramanik, Sujoy Saha, Sandip Chakraborty, Niloy Ganguly, Subrata Nandi. CRIMP: Here Crisis Mapping Goes Offline. \textit{\textcolor{blue}{Elsevier Journal of Network and Computer Applications (JNCA)}} 146 (2019): 102418.

\item   \textbf{[WSDM-19]} Aditya Chetan*, Brihi Joshi*, \textbf{\underline{Hridoy Sankar Dutta}}*, Tanmoy Chakraborty. CoReRank: Ranking to Detect Users Involved in Blackmarket-based Collusive Retweeting Activities. \textit{\textcolor{blue}{12th ACM International Conference on Web Search and Data Mining (WSDM)}}, pp. 330-338. 2019.


\item  \textbf{[ASONAM-18]} \textbf{\underline{Hridoy Sankar Dutta}}, Aditya Chetan, Brihi Joshi, Tanmoy Chakraborty. Retweet Us, We Will Retweet You: Spotting Collusive Retweeters Involved in Blackmarket Services, \textit{IEEE/ACM International Conference on Advances in Social Networks Analysis and Mining} (ASONAM), pp. 242-249. IEEE, 2018.

\item Partha Sarathi Paul, \textbf{\underline{Hridoy Sankar Dutta}}, Bishakh Chandra Ghosh, Krishnandu Hazra, Sandip Chakraborty, Sujoy Saha, Subrata Nandi. Offline crisis mapping by opportunistic dissemination of crisis data after large-scale disasters, \textit{\textcolor{blue}{2nd ACM SIGSPATIAL International Workshop on the Use of GIS in Emergency Management}}, pp. 1-8. 2016.

\item  \textbf{[SAC-14]} Sandip Chakraborty, Suchetana Chakraborty, Sushanta Karmakar, \textbf{\underline{Hridoy Sankar Dutta}}. Hierarchical topology adaptation for distributed convergecast applications, In \textit{29th Annual ACM Symposium on Applied Computing}, pp. 405-407. 2014.\end{itemize}


\section{Datasets}
\begin{itemize}[leftmargin=*]
\item \textbf{\underline{Hridoy Sankar Dutta}}. YT-30M: A multi-lingual multi-category dataset of YouTube comments.\\
\textit{\small{\href{https://huggingface.co/datasets/hridaydutta123/YT-100K/}{HuggingFace} downloads: 917}},
\textit{\small{Industry adoption: ActiveFence, USA}}
\item \textbf{\underline{Hridoy Sankar Dutta}}, Udit Arora and Tanmoy Chakraborty
...
\section{Funding}
\textbf{Deakin Cyber Collaboration Grants Scheme 2026 (Co-Pi)} \hfill 6000 AUD  \\
\emph{Deakin University} 

\textbf{SEBE 2026 Academic Travel Scheme} \hfill 3430 AUD  \\
\emph{Deakin University} 

\textbf{Peer-review ECR Support Scheme (PRESS)} \hfill 4250 AUD  \\
\emph{Deakin University} 

\textbf{Cohere Labs Catalyst Grant} \hfill 500 USD  \\
\emph{Cohere Labs} 
...
\emph{SIT753: Professional Practices in IT (SEBE Teaching Excellence Award)} \hfill July - Oct 2024/2025 
...
%\\
%textbf{Winter Research Intern, DISARM Group, NIT Durgapur} \\
...
\item Member of the Australian Computing Society (MACS).
\item SEBE Teaching Excellence Award 2025,  Deakin University.
...
\begin{itemize}[leftmargin=*]
\item Public Library of Science ONE (PLOS One) (Reviewer).
