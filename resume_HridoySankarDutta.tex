...
\item Deepak Thukral, \textbf{Hridoy Sankar Dutta}, Vikram Goyal, Tanmoy Chakraborty. Catch Me if You Can: Spotting Collusive Users Involved in Blackmarket Following Services, In \textit{Thirty-Third AAAI Conference on Artificial Intelligence} (AAAI), Hawaii, USA, Jan 27-Feb 1, 2019. \textbf{(Submitted)} 

\item Aditya Chetan, Brihi Joshi, \textbf{Hridoy Sankar Dutta}, Tanmoy Chakraborty. CoReRank: Ranking to Detect Users Involved in Blackmarket-based Collusive Retweeting Activities, In \textit{Proceedings of the Twelfth ACM International Conference on Web Search and Data Mining} (WSDM), Melbourne, Australia, Feb 11-15, 2019. \textbf{(Submitted)}
